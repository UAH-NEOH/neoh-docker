...
def imerg_handler(event):
    ...
    for district in districts:
        ...
        minlondist = 180.0
        maxlondist = -180.0
        distPoly, minlatdist, minlondist, maxlatdist, maxlondist = find_poly_box(district, minlatdist, minlondist,
                                                                                 maxlatdist, maxlondist)
    ...
    for file in filenames:
        ...
        try:
            ...
            data_var = dataset[var_name][0, start_lon_ind:end_lon_ind,
                       start_lat_ind:end_lat_ind].data  # time, lon, lat
            ...
            for district in districts:
                ...
                accumPrecipByDistrict(distPolyByName[name], data_var, lat, lon, districtPrecip, minlatByName[name],
                                      minlonByName[name], maxlatByName[name], maxlonByName[name])
